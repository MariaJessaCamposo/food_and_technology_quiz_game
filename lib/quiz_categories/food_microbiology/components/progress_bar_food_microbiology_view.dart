...
class ProgressBarFoodMicrobiology extends StatelessWidget {
  const ProgressBarFoodMicrobiology({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GetBuilder<QuestionControllerFoodMicrobiology>(
        init: QuestionControllerFoodMicrobiology(),
        builder: (controller) {
          return Stack(
            children: [
