...
class ProgressBarNutritionAndHealth extends StatelessWidget {
  const ProgressBarNutritionAndHealth({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GetBuilder<QuestionControllerNutritionAndHealth>(
