...
class ProgressBarEnzymeTechnologyView extends StatelessWidget {
  const ProgressBarEnzymeTechnologyView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GetBuilder<QuestionControllerEnzymeTechnology>(
        init: QuestionControllerEnzymeTechnology(),
        builder: (controller) {
          return Stack(
            children: [
