...
import 'package:quiz_app/quiz_categories/kte/bpp/hard/components/progress_bar_bpp_hard_view.dart';
import 'package:quiz_app/quiz_categories/kte/bpp/hard/components/question_card_bpp_hard_view.dart';
...
class BodyBppHardView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    QuestionControllerBppHard questionController = Get.put(QuestionControllerBppHard());
    return Stack(
      children: [
