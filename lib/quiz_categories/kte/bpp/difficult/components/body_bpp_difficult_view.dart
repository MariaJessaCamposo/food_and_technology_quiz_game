...
import 'package:quiz_app/quiz_categories/kte/bpp/difficult/components/progress_bar_bpp_difficult_view.dart';
import 'package:quiz_app/quiz_categories/kte/bpp/difficult/components/question_card_bpp_difficult_view.dart';
...
class BodyBppDifficultView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    QuestionControllerBppDifficult questionController = Get.put(QuestionControllerBppDifficult());
    return Stack(
      children: [
                ...
                Padding(
                  ...
                  child: Obx(
                      ...
                      TextSpan(
                        ...
                        children: [
                          TextSpan(
                            text: "/${questionController.bppDifficultQuestions.length}",
                            style: Theme.of(context)
                                .textTheme
                                .headline5
                                ?.copyWith(color: kSecondaryColor),
