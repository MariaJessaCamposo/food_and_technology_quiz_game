...
class ProgressBarFoodHS extends StatelessWidget {
  const ProgressBarFoodHS({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GetBuilder<QuestionControllerFoodHS>(
        init: QuestionControllerFoodHS(),
        builder: (controller) {
          return Stack(
            children: [
