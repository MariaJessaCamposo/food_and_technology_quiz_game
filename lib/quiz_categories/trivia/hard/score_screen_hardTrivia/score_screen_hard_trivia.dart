...
class ScoreScreenHardTrivia extends StatelessWidget {
  const ScoreScreenHardTrivia({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    QuestionControllerHardTrivia qnController =
          ...
          Column(
            children: [
              ...
              Text(
                ...
                "${qnController.numOfCorrectAns * 10}/${qnController.hardTriviaQuestions.length * 10}",
                style: Theme.of(context)
                    .textTheme
                    .headline4
                    ?.copyWith(color: kSecondaryColor),
