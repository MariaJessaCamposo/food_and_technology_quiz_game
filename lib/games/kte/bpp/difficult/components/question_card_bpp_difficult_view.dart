...
import 'package:quiz_app/games/kte/bpp/difficult/components/option_bpp_difficult_view.dart';
...
class QuestionCardBppDifficultView extends StatelessWidget {
  const QuestionCardBppDifficultView({Key? key, required this.question})
      : super(key: key);
