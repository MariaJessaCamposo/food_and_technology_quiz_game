...
class ProgressBarBppDifficult extends StatelessWidget {
  const ProgressBarBppDifficult({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GetBuilder<QuestionControllerBppDifficult>(
