...
import 'package:quiz_app/games/trivia/easy/components/question_card_easy_trivia_view.dart';
import 'package:quiz_app/games/trivia/easy/question_controller_trivia/question_controller_easy_trivia.dart';

import 'progress_bar_easy_trivia_view.dart';
...
class BodyTriviaView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    QuestionControllerTrivia questionController =
        Get.put(QuestionControllerTrivia());
    return Stack(
      children: [
                ...
                () => Text.rich(
                  TextSpan(
                    ...
                    children: [
                      TextSpan(
                        text:
                            "/${questionController.easyTriviaQuestions.length}",
                        style: Theme.of(context)
                            .textTheme
                            .headline5
                            ?.copyWith(color: kSecondaryColor),
